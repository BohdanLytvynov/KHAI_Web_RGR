        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    author_name = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    author_surename = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    author_birth_date = table.Column<DateOnly>(type: "DATE", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Book_Geners", x => new { x.GenreId, x.BookId });
                    table.ForeignKey(
                        name: "FK_Book_Geners_Books_BookId",
                        column: x => x.BookId,
                        principalSchema: "bookStore",
                        principalTable: "Books",
                        principalColumn: "book_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Book_Geners_Genres_GenreId",
                        column: x => x.GenreId,
                        principalSchema: "bookStore",
